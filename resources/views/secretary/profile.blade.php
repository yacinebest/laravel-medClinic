                ...
                <div class="col-lg-4 col-xl-3">
                    <div class="profile-content-left pt-5 pb-3 px-3 px-xl-5">
                        <div class="card text-center widget-profile px-0 border-0">
                            <div class="card-body">
                                <h4 class="py-2 text-dark">{{ Auth::guard('secretary')->user()->last_name . ' ' . Auth::guard('secretary')->user()->first_name }}</h4>
                            </div>
                        </div>
                        <hr class="w-100">
                        <div class="contact-info pt-4">
                            ...
                            <p>{{ Auth::guard('secretary')->user()->email }}</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="profile-content-right py-5">
                        ...
                        <div class="tab-content mt-4 px-3 px-xl-5" id="myTabContent">
                            <div class="tab-pane fade show active" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                ...
                                @endif
                                <form method="POST" action="{{ route('secretary.updateprofile') }}" id="update-form">
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label>Nom:</label>
                                                <input name="last_name" type="text" class="form-control @error('last_name') is-invalid @enderror" value="{{ Auth::guard('secretary')->user()->last_name }}" placeholder="Nom">
                                            </div>
                                            @error('last_name')
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label>Prénom:</label>
                                                <input name="first_name" type="text" class="form-control @error('first_name') is-invalid @enderror" value="{{ Auth::guard('secretary')->user()->first_name }}" placeholder="Prénom">
                                            </div>
                                            @error('first_name')
                                            <div class="alert alert-danger alert-highlighted">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Email:</label>
                                                <input name="email" type="email" class="form-control @error('email') is-invalid @enderror" value="{{ Auth::guard('secretary')->user()->email }}" placeholder="Email">
                                            </div>
                                            @error('email')
                                            <div class="alert alert-danger alert-highlighted">{{ $message }}</div>
                                            @enderror
                            ...
                            <div class="tab-pane fade" id="settings" role="tabpanel" aria-labelledby="settings-tab">
                                <form method="POST" action="{{ route('secretary.updatepassword') }}" id="update-password">
                                    @csrf
                                    <div class="row">
